...
namespace NatCamU.Core.Platforms {
    ...
    public sealed partial class NatCamAndroid : AndroidJavaProxy, INatCam {
        ...
        private void onPhoto (AndroidJavaObject pixelBuffer, int width, int height, byte orientation) {
            var pixelData = AndroidJNI.FromByteArray(pixelBuffer.Call<AndroidJavaObject>("array").GetRawObject());
            dispatch.Dispatch(() => {
